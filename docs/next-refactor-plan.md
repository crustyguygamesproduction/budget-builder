...
- Page-native first-run guidance lives in `src/components/PageGuide.jsx`; user-scoped page guide memory and replay live in `src/components/onboarding/onboardingState.js`.
...
- Keep page guides action-led: first statement, Review checks, Calendar truth, one goal, then Coach.
